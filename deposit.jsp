...
<div class="card shadow p-4" style="width:420px;">
    ...
    <div class="d-flex align-items-center mb-4 gap-2">
        ...
        <h5 class="fw-bold mb-0"><i class="bi bi-arrow-down-circle-fill text-success me-2"></i>Deposit Money</h5>
    </div>

    <!-- Balance info -->
    <div class="bg-light rounded p-3 mb-3 text-center">
        <p class="mb-0 text-muted small">Current Balance</p>
        <h4 class="fw-bold text-success mb-0">₹ <%= String.format("%,.2f", user.getBalance()) %></h4>
    </div>
    ...
    <div class="alert alert-danger py-2"><i class="bi bi-x-circle-fill me-1"></i> Deposit failed. Please try again.</div>
    <% } %>
    ...
    <form action="DepositServlet" method="post">
        <div class="mb-3">
            ...
            <input type="number" name="amount" class="form-control form-control-lg"
                   placeholder="0.00" min="1" step="0.01" required autofocus>
        </div>
        ...
        <button type="submit" class="btn btn-success w-100 fw-semibold">Confirm Deposit</button>
    </form>
</div>
